...
public class UserinfoDAO extends BaseHibernateDAO {
	...
	public static final String OUTTASKID = "outtaskid";
	public static final String INTASKID = "intaskid";
	...
	public List findByOuttaskid(Object outtaskid) {
		return findByProperty(OUTTASKID, outtaskid);
	}

	public List findByIntaskid(Object intaskid) {
		return findByProperty(INTASKID, intaskid);
	}
