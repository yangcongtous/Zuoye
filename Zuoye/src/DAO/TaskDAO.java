...
public class TaskDAO extends BaseHibernateDAO {
	...
	public static final String OUTOK = "outok";
	public static final String INOK = "inok";
	public static final String INUSERID = "inuserid";
	public static final String OUTINTID = "outintid";
	...
	public Task findById(java.lang.Integer id) {
		...
		try {
			Task instance = (Task) getSession().get("DAO.Task", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Task instance) {
		...
		try {
			List results = getSession().createCriteria("DAO.Task")
	...
	public List findByOutok(Object outok) {
		return findByProperty(OUTOK, outok);
	}

	public List findByInok(Object inok) {
		return findByProperty(INOK, inok);
	}

	public List findByInuserid(Object inuserid) {
		return findByProperty(INUSERID, inuserid);
	}

	public List findByOutintid(Object outintid) {
		return findByProperty(OUTINTID, outintid);
	}

	public List findByAccept(Object accept) {
		return findByProperty(ACCEPT, accept);
	}
