...
var jQuery18 = jQuery.noConflict();
...
//      console.info("got timeout: "+uuid);
        ...
        if(msgObj != null){
            WebIM.ui.recieveMsg([ {
                from : msgObj.msg.from,
                to : msgObj.msg.to,
                fromNick : msgObj.msg.fromNick,
                toNick : msgObj.msg.toNick,
                msg : msgObj.msg.msg + " 没有发送成功！",
                sendtime : new Date().getTime(),
                timestamp : new Date().getTime(),
                isSelf : true,
                isFailAlert:true
            } ]);//TODO: from = msg.to, to = me; alert the user that this message has failed!
...
//    });
    ...
    WebIM.startTrackCookie = function(){
        ...
        document.cookie="webimMainPage="+WebIM.pageId+";expires=; path=/; domain=.zhubajie.com";
        ...
        jQuery18(window).bind('beforeunload', function(){
            ...
            document.cookie= "webimMainPage=;expires="+exp.toGMTString()+"; path=/; domain=.zhubajie.com";
        });
    }
